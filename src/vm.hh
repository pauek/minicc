...
enum BasicType : uint8_t { I32, U32, F32, I64, U64, F64, FirstFreeType };
enum CompositeType : uint8_t { Struct, Array };
...
template <CompositeType T> struct TypeDescrDerived : TypeDescr {
...
public:
  ...
  template <typename T> bool Read(ChunkIndex index, size_t offset, T &value);
};

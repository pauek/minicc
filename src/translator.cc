...
const char *numeral[MAX_NUMERAL + 1] = {"zeroth", "first", "second",  "third", "fourth",
...
Catalan
	 ...
	 {"usage: minicc <filename>", "uso:   minicc <fichero>", "ús:    minicc <fitxer>"},
	 {"UNIMPLEMENTED", "NO IMPLEMENTADO", "NO IMPLEMENTAT"},
	 {"Compilation Error", "Error de compilación", "Error de compilació"},
	 {"Execution Error", "Error de ejecución", "Error d'execució"},
	 {"UNIMPLEMENTED", "NO IMPLEMENTADO", "NO IMPLEMENTAT"},
	 {"Unexpected character '%c'", "Caracter '%c' inesperado", "Caracter '%c' inesperat"},
	 ...
	 {"Error when reading input", "Error al leer de la entrada", "Error al llegir de l'entrada"},
	 {"Unexpected '%s' here.", "No esperaba '%s' aquí.", "No esperava '%s' aquí."},
	 {"Macro '#%s' unknown.", "Macro '#%s' desconocida.", "Macro '#%s' desconeguda."},
	 {"'#include' missing closing '%c'.", "Al '#include' le falta el '%c' de cerrar.",
	  "A l'#include li falta el '%c' de tancar."},
	 {"Expected '%s' here.", "Esperaba un '%s' aquí.", "Esperava un '%s' aquí."},
	 ...
	 {"Expected '\"' or '<' here.", "Esperaba '\"' o '<' aquí.", "Esperava '\"' o '<' aquí."},
	 {"Expected an integer here.", "Esperaba un entero aquí.", "Esperaba un enter aquí."},
	 {"The 'main' function does not exist.", "La función 'main' no existe.",
	  "La funció 'main no existeix."},
	 {"The program begins.", "Empieza el programa.", "Comença el programa."},
	 {"The program ends.", "Termina el programa.", "Acaba el programa."},
	 ...
	 {"%s is returned.", "Se retorna %s.", "Es retorna %s."},
	 {"Some output is written.", "Se escribe a la salida.", "S'escriu a la sortida."},
	 {"Some input is read.", "Se lee de la entrada.", "Es llegeix de l'entrada."},
	 {"The expression evaluated to %s.", "La expresión ha dado %s.", "L'expressió ha donat %s."},
	 {"We assign the value.", "Asignamos el valor.", "Assignem el valor."},
	 {"We evaluate the %s parameter.", "Se evalúa el %s parámetro.", "S'avalua el %s paràmetre."},
	 {"first", "primer", "primer"},
	 ...
	 {"We jump to function '%s'.", "Saltamos a la función '%s'.", "Saltem a la funció '%s'."},
	 {"Variable '%s' is declared.", "Se declara la variable '%s'.", "Es declara la variable '%s'."},
